	...
	({ product, balance, onClick }) => (
		...
		<div className="panel panel-default">
			<div className="panel-heading">
				Price: <strong>R{product.price}</strong> Count: <strong>{product.count}</strong>
			</div>
			...
			<div className="panel-footer">
				{
					...
					<label className="btn-sm text-warning">Load <strong>R{product.price - balance.value}</strong> more</label>
				}
			</div>
		</div>
	)
